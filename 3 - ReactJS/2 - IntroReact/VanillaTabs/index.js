...
function highlightButton(btn) {
  // Função para destacar o botão da aba ativa
...
function handleClick(event) {
  // Função para lidar com o evento de clique em um botão de aba
  const buttonMap = {
    // Mapeia os IDs dos botões para índices do array de conteúdo
    "btn-why-react": 0,
    "btn-core-features": 1,
    "btn-resources": 2,
  };
...
[btnWhyReact, btnCoreFeature, btnResources].forEach((btn) =>

...
const linkStyle = ({ isActive }) => ({
  // Função que retorna um objeto de estilos dependendo do estado ativo.
...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Link para "/" que ficará ativo na página inicial. */}
      <NavLink to="/sobre" style={linkStyle}>
        Sobre
      </NavLink>{" "}
      {/* Link para "/sobre" que ficará ativo nessa página. */}
      <NavLink to="/posts/10" style={linkStyle}>
        Post 10
      </NavLink>{" "}
      {/* Link para "/posts/10", útil para exemplo. */}
    </nav>
  );
}

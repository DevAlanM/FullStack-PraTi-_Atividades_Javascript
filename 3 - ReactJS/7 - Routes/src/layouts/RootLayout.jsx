...
export default function RootLayout() {
  // Define o layout raiz, usado como "casca" das páginas.
  return (
    <div style={{ fontFamily: "system-ui, Arial", lineHeight: 1.5 }}>
      {" "}
      {/* Container geral com estilos globais. */}
      <Navbar /> {/* O menu de navegação aparece em todas as páginas. */}
      <main style={{ padding: 16 }}>
        {" "}
        {/* Área principal do layout com espaçamento interno. */}
        <Outlet />{" "}
        {/* Aqui será inserido o componente da rota filha correspondente. */}
      </main>
    </div>
  );
}
